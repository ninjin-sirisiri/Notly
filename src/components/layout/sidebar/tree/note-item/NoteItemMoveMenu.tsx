...
type NoteItemMoveMenuProps = {
  onMove: (folderId: number | null) => void;
};

export function NoteItemMoveMenu({ onMove }: NoteItemMoveMenuProps) {
  const { folders } = useFolderStore();

  function buildTree(parentId: number | null): { folder: (typeof folders)[0]; depth: number }[] {
