...
const api = {
  ...
  folder: {
    ...
    delete: (id: string): Promise<{ success: boolean }> =>
      ipcRenderer.invoke("FOLDER_DELETE", id),
  },
  ...
  tag: {
    ...
    delete: (id: string): Promise<{ success: boolean }> =>
      ipcRenderer.invoke("TAG_DELETE", id),
  },
  ...
  template: {
    ...
    list: (): Promise<{ templates: Template[] }> =>
      ipcRenderer.invoke("TEMPLATE_LIST"),

    read: (id: string): Promise<{ template: Template }> =>
      ipcRenderer.invoke("TEMPLATE_READ", id),
